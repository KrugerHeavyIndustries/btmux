...
void cf_init(void)
{
    ...
    mudconf.btech_newjump = 1;
    mudconf.btech_bridge_collision = 1;
...
CONF conftable[] = {
    ...
    {(char *) "btech_newjump",
        cf_int, CA_GOD, &mudconf.btech_newjump, 0},
    {(char *) "btech_bridge_collision",
        cf_int, CA_GOD, &mudconf.btech_bridge_collision, 0},
